...
export type GameState = 'setup' | 'playerTurn' | 'dareDraw' | 'swipeDecision' | 'skipFlow' | 'acceptFlow' | 'actionCardHiddenDraw' | 'continueScreen' | 'endgameTriggered' | 'dareRevealGrid' | 'dareFlipReveal' | 'actionCardReveal' | 'finalResult' | 'reset' | 'awaitingConfirmation';
